...
****
To create a character for a campaign, Players need to purchase 0 or more Disadvantages from a catalog of Disadvantages.
****

.*Quirk: Mental*
****
To create a character for a campaign, Players need to purchase 0 or more Mental Quirks from a catalog of Quirks.
****

.*Quirk: Physical*
****
To create a character for a campaign, Players need to purchase 0 or more Physical Quirks from a catalog of Quirks.
****
