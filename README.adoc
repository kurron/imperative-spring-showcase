...
.*Quirk: Mental*
****
To create a character for a campaign, Players need to purchase 0 or more Mental Quirks from a catalog of Quirks. A "purchased" Quirk will add back points to the Character Points pool.

****

.*Quirk: Physical*
****
To create a character for a campaign, Players need to purchase 0 or more Physical Quirks from a catalog of Quirks. A "purchased" Quirk will add back points to the Character Points pool.
****
