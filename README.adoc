...
.*Skills*
****
To create a character for a campaign, Players may select 0 or more Skills from a catalog of Quirks. Each selected Skill will have a cost calculated from the following table:
